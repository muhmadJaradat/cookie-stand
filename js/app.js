...
const tfooter = table.appendChild(document.createElement('tfoot'));
...
let dynamicCon = function () {
  const trdynEl = tfooter.appendChild(document.createElement('tr'));
...
function addNewLocation(event) {
  ...
  let avgerageCookies = event.target.avgerCookies.value;
  let addLocation = new Location(locName, Number(minCus), Number(maxCus), Number(avgerageCookies));
  addLocation.getSoldCookies();
  addLocation.render();
